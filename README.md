...
- Prompt Run History for browsing, filtering, opening detail views, and reusing saved prompt runs
...
| Prompt Workflows | Prompt Run History | Browse saved runs, filter by template, open run details, and reopen output in downstream tools | Dedicated history view for saved prompt output |
...
4. Review a saved run detail page
