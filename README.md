...
- Prompt Run History for browsing, filtering, opening detail views, adding notes, and reusing saved prompt runs
...
| Prompt Workflows | Prompt Run History | Browse saved runs, filter by template, open run details, add notes, and reopen output in downstream tools | Dedicated history view for saved prompt output |
...
4. Review a saved run detail page and add a short note
5. Continue into `Prompt Diff` or `Code Viewer`
