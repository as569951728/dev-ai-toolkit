...
- Prompt Run History for browsing, filtering, searching notes, opening detail views, adding notes, and reusing saved prompt runs
...
| Prompt Workflows | Prompt Run History | Browse saved runs, filter by template, search note content, open run details, add notes, and reopen output in downstream tools | Dedicated history view for saved prompt output |
...
5. Review a saved run detail page and add a short note
